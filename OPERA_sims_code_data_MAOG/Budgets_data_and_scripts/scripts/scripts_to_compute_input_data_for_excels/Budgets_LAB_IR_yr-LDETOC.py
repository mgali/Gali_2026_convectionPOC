...
variables = ["tottrdldetoc", "mort2ldetoc","zmesonoassim","sdetoc2ldetocagg","doc2ldetocagg",\
              "zmesoffldetoc","zmesofragmldetoc","remldetoc","ldetoc2sdetoc",\
              "xadldetoc","yadldetoc","zadldetoc","ldfldetoc","zdfldetoc","trdexpldetoc"]


#variables = ["tottrdpkt","xadpkt","yadpkt","zadpkt","ldfpkt",\
#             "zdfpkt"]

#variables = ["ldfpkt", "zdfpkt"]

diag_list= ['a683'] #['a67o'] #,'a683','a5xl','a5kq']
...
yrStrt=1998
yrLast=2010
type = 'large_POC_budgets' #'pkt' # 'small_POC_budgets'
    ...
    for var in variables:
        ...
        with warnings.catch_warnings():
            ...
            for yr in range(yrStrt,yrLast):
                ...
                cube = iris.load_cube("/esarchive/exp/nemo/"+expid+"/original_files/cmorfiles/OPERA/EC-Earth-Consortium/EC-Earth3/opera-control/r1i1p1f1/Omon/" + var + "/gn/"+cmorversion+"/" + var +"_Omon_EC-Earth3_opera-control_r1i1p1f1_gn_"+ str(yr) + "01-" + str(yr) + "12.nc")
