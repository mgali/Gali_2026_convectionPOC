...
from esmvalcore.preprocessor import climate_statistics,extract_volume,concatenate, axis_statistics, area_statistics,extract_shape,add_supplementary_variables
...
diag_list= ['a683'] #['a67o','a5xl'] #['a67o'] #,'a683','a5xl','a5kq']
...
yrStrt=1998
yrLast=2010
type = 'small_POC_budgets' #'pkt' # 'small_POC_budgets'
